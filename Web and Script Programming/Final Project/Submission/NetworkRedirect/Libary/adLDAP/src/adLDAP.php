...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@TownHouse.th";
    ...
    * @var string
    */
	protected $baseDn = "DC=townhouse,DC=th"; 
    ...
    * @var int 
    */ 
    protected $adPort = self::ADLDAP_LDAPS_PORT; 
    ...
    * @var array
    */
    protected $domainControllers = array("10.150.2.2");
    ...
    * @var string
    */
	protected $adminUsername = 'webAD';
    protected $adminPassword = 'webtestAD';
